...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { sender: "bot", text: "Hi! How can I assist you today? Ask about our product categories!" },
  ]);
        ...
        messages: [
          {
            ...
            - Developed by MenteE's Leader🥀.
            - Provide accurate information based on the following product data:
            - just be so specific. no more then 100 words.
            - dont show prices unless asks for.
            ${productContext}
            Query: "${input}"`,
          },
        ],
  ...
  const handleClearHistory = () => {
    setMessages([
      { sender: "bot", text: "Hi! its Nainzaka here..." },
    ]);
  };
  ...
  {/* Chatbot Popup */}
  {isOpen && (
    <div className="bg-white rounded-xl shadow-2xl w-96 mt-4 overflow-hidden" style={{
      ...
      <div className="border-t border-gray-200 p-4 bg-white">
        ...
        <button
          ...
          className="mt-3 text-xs text-[#660033] hover:text-[#4A0025] transition-colors"
        >
